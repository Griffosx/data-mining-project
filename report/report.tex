...
In the following subsections, we delve deeper into our feature selection process, detailing how we identified the most relevant predictors from our merged dataset. We also explore our feature engineering methodology, which helped us capture complex temporal and spatial patterns in our data. Finally, we present our preliminary analysis of the response variables, setting the stage for our subsequent modeling efforts.
...
Initial exploratory analysis revealed that the distributions of these pollutants exhibited strong right-skewed patterns across all five cities, as illustrated in Figure \ref{fig:skewness}. This visualization clearly demonstrates the asymmetric nature of pollutant concentrations, with a high frequency of lower values and a long tail extending towards higher concentrations.
